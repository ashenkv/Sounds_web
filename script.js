...
//     var eye2 = document.getElementById("e2");
...
function forgotPassword() {
    ...
    r.onreadystatechange = function () {
      if (r.readyState == 4) {
        var t = r.responseText;
        if (t == "Success") {
          alert("verification Code Send to Email. Please Check the Email.");
          var m = document.getElementById("PasswordModel");
          bm = new bootstrap.Modal(m);
          bm.show();
        } else {
          alert(t);
  ...
  function showPassword3() {
    var show_text = document.getElementById("p");
...
//     // f.append("col_in", clr_input.value);
...
function addProduct() {
    ...
    r.onreadystatechange = function () {
      if (r.readyState == 4) {
        ...
        if (t == "Product and images saved successfully") {
          alert("Product Added Successfully");
          window.location.reload();
        } else {
          alert(t);
...
function removeAllHistory(id){
    ...
    r.open("GET","removeAllHistoryProcess.php?id="+id,true);
    r.send();
}
    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            ...
            if (t == "1") {
                ...
                var payment = {
                    "sandbox": true,
                    "merchant_id": "1222073",    // Replace your Merchant ID
                    "return_url": "http://localhost/sounds/singleProductView.php?id" + id,     // Important
                    "cancel_url": "http://localhost/sounds/singleProductView.php?id" + id,     // Important
...
function CheckOutBuyNow(id) {
    ...
    r.open("GET", "checkoutpriceprocess.php?id=" + id + "&qty=" + qty, true)
    r.send();
...
function getNow(id) {
    ...
    var input = document.getElementById("qty_cart_input" + id).value;
    ...
    var form = new FormData();
    form.append("id", id);
    form.append("qty", input);
    form.append("total", total.innerHTML);
    ...
    r.open("POST", "purchaseHistoryProcess.php", true);
    r.send(form);
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4){
            ...
            if(txt == "blocked"){
                ...
                document.getElementById("ub"+email).classList = "btn btn-dark rounded-4";
            }else if(txt == "unblocked"){
                document.getElementById("ub"+email).innerHTML = "Block";
                document.getElementById("ub"+email).classList = "btn btn-danger rounded-4";
            }else{
                alert (txt);
            }
        }
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4){
            ...
            if(txt == "blocked"){
                ...
                document.getElementById("pb"+id).classList = "btn btn-dark rounded-4";
            }else if(txt == "unblocked"){
                document.getElementById("pb"+id).innerHTML = "Block";
                document.getElementById("pb"+id).classList = "btn btn-danger rounded-4";
            }else{
                alert (txt);
            }
        }
    ...
    r.onreadystatechange = function(){
        if(r.readyState == 4){
            ...
            if(t == 1){
                ...
                document.getElementById("btn"+id).classList = "btn btn-light mt-1 mb-1";
                ...
                document.getElementById("btn"+id).classList = "btn btn-light mt-1 mb-1 disabled";
            }else{
                alert(t);
            }
        }
...
function watchSearch() {
    ...
    r.onreadystatechange = function () {
        ...
        if (r.readyState == 4) {
            var t = r.responseText;
            document.getElementById("search1").innerHTML = t;
        }
...
// function mprSearch(x) {
//     var txt = document.getElementById("mpr_search_txt");
//     var select = document.getElementById("mpr_search_select");
...
//         if (r.readyState == 4) {
//             var t = r.responseText;
//             document.getElementById("mprSearchResult").innerHTML = t;
//         }
//     }

//     r.open("POST", "mprSearchProcess.php", true);
//     r.send(f);
