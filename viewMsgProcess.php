...
?>
        <!-- sender -->
        <div class="media mb-0 w-75">
            <?php

            if (isset($img_data["path"])) {
            ?>
                <img src="<?php echo $img_data["path"]; ?>" width="35px" class="rounded-circle" />
            <?php
            } else {
            ?>
                <img src="resource/logo.png" width="35px" class="rounded-circle">
            <?php
            }

            ?>

            <div class="media-body me-1">
                <div class="bg-white border rounded py-2 px-3 mb-0">
    ...
    ?>
        <!-- receiver -->
        <div class="media mb-0 w-75 offset-3 col-9">
            <div class="media-body">
                <div class="border1 rounded py-2 px-3 mb-0">
                    <p class="mb-0 text-secondary"><?php echo $msg_data["content"]; ?></p>
                </div>
                <p class="small fw-bold text-black-50 text-end"><?php echo $msg_data["date_time"]; ?></p> 
            </div>
        </div>
