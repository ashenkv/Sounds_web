...
<head>
    ...
    <title>Earphones & Headphones->See All | SoundS</title>
			            ...
			            <div class="col-12 mb-3">
                            <div class="row border border-primary">
                                ...
                                <div class="col-12 bg-dark mt-1">
                                    <h3 class=" text-white text-center my-2">Earphones & Headphones</h3>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        $product_rs = Database::search("SELECT * FROM `product` WHERE `category_id`='1' AND 
                                            ...
                                            <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                                ...
                                                <div class="card-body ms-0 m-0 text-center">
                                                    ...
                                                    ?>
                                                        ...
                                                        <!-- <a class="col-12 btn btn-dark mt-2 disabled">Get Now</a> -->
                                                        <a class="col-5 offset-2  btn btn-warning mt-2 disabled">
