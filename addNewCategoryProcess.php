...
if(isset($_POST["email"]) && isset($_POST["name"])){
    if($_SESSION["au"]["email"] == $_POST["email"]){
        ...
        if($category_num == 0){
            ...
            $mail->Password = 'xtutvjcfqinpsonm';
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            $mail->setFrom('ashenlalantha71@gmail.com', 'Admin Verification');
            $mail->addReplyTo('ashenlalantha71@gmail.com', 'Admin Verification');
            $mail->addAddress($umail);
            $mail->isHTML(true);
            $mail->Subject = 'SoundS Admin Verification Code for Add New Category';
