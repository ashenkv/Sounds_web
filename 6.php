...
<head>
    ...
    <title>Instruments->See All | SoundS</title>
			            ...
			            <div class="col-12 mb-3">
                            <div class="row border border-primary">
                                ...
                                <div class="col-12 bg-dark mt-1">
                                    <h3 class=" text-white text-center my-2">Instruments</h3>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        $product_rs = Database::search("SELECT * FROM `product` WHERE `category_id`='6' AND 
