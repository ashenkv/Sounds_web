...
?>
    ...
    <head>
        ...
        <title>Admin Panel | SoundS</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- <div class="col-12 col-lg-2">
                    <div class="row">
                        <div class="col-12 align-items-start ad7 vh-100 rounded-end">
                            <div class="row g-1 text-center">

                                <div class="col-12 mt-5">
                                    <h4 class=" text-warning fw-bold">[Admin]</h4>
                                    <h4 class="text-white"><?php echo $_SESSION["au"]["fname"] . " " . $_SESSION["au"]["lname"]; ?></h4>
                                    <hr class="border border-1 border-white" />
                                </div>
                                <div class="nav flex-column nav-pills me-3 mt-3" role="tablist" aria-orientation="vertical">
                                    <nav class="nav flex-column">
                                        <a class="nav-link active bg-info rounded-4" aria-current="page" href="#">Dashboard</a>
                                        <a class="nav-link text-info" href="manageUsers.php">Manage Users</a>
                                        <a class="nav-link text-info" href="manageProducts.php">Manage Products</a>
                                    </nav>
                                </div>
                                <div class="col-12 mt-5">
                                    <hr class="border border-1 border-white" />
                                ...
                                <div class="col-12 mt-3 d-grid">
                                    ...
                                    <input type="date" class="form-control" />
                                    <a href="#" class="btn btn-light rounded-4 mt-2">Search</a>
                                    <hr class="border border-1 border-white" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row ad7 mt-1">
                                ...
                                <div class="col-8 offset-2 text-white fw-bold mb-1 mt-2">
                                    <h2 class="fw-bold fs-1 text-center">Admin Panel</h2>
                                </div>
  ...
  <div class="offcanvas-body">
    ...
    <div class="col-12">
        <div class="row">
        <a class=" text-primary btn btn-light border border-1 fs-5 rounded-0 text-start" href="adminPanel.php">Admin Panel</a><br>    
    ...
    <div class="col-12">
        ...
        <a class="fs-5 btn btn-light text-dark border border-1 rounded-0 text-start" href="sellingProcess.php">Selling Process <i class="bi bi-check2-all fs-5"></i></a>
                        ...
                        <!-- <div class="text-white fw-bold mb-1 mt-3 ad7">
                            <h2 class="fw-bold fs-1 text-center">Dashboard</h2>
                        ...
                        <div class="col-12">
                            <div class="row g-1">
                                ...
                                <div class="col-12 px-1 shadow rounded-4">
                                    <div class="row g-1 my-lg-3">
                                        <div class="col-12 bg-dark border border-warning text-light text-center rounded-0 " style="height: 100px;">
                                            <br />
                                            <span class="fs-5">Daily Earnings</span>
                                            <br />
                                            <?php
                                            ...
                                            ?>
                                            <span class="fs-3 font">Rs. <?php echo $a; ?> .00</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 bg-light border border-secondary text-dark text-center rounded-0" style="height: 100px;">
                                            <br />
                                            <span class="fs-5">Monthly Earnings</span>
                                            <br />

                                            <span class="fs-4 font">Rs. <?php echo $b; ?> .00</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 bg-light border border-secondary text-dark text-center rounded-0" style="height: 100px;">
                                            <br />
                                            <span class="fs-5">Today Sellings</span>
                                            <br />
                                            <span class="fs-4 font"><?php echo $c; ?> Items</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-4 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 bg-dark border border-warning text-light text-center rounded-0" style="height: 100px;">
                                            <br />
                                            <span class="fs-5">Monthly Sellings</span>
                                            <br />
                                            <span class="fs-4 font"><?php echo $e; ?> Items</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-4 px-1">
                                    <div class="row g-1">
                                        <div class="col-12 bg-dark border border-warning text-white text-center rounded-0" style="height: 100px;">
                                            <br />
                                            <span class="fs-5">Total Sellings</span>
                                            <br />
                                            <span class="fs-4 font"><?php echo $f; ?> Items</span>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-12 col-lg-4 px-1 shadow">
                                    <div class="row g-1">
                                        <div class="col-12 bg-dark border border-warning text-white text-center rounded-0" style="height: 100px;">
                                            <br />
                                            <span class="fs-5">Total Engagements</span>
                                            <br />
                                            <?php
                                            $user_rs = Database::search("SELECT * FROM `user`");
                                            $user_num = $user_rs->num_rows;
                                            ?>
                                            <span class="fs-4 font"><?php echo $user_num; ?> Members</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 bg-dark">
                            <div class="row">
                                <!-- <div class="col-12 col-lg-2 text-center my-3">
                                    <label class="form-label fs-4 fw-bold text-light">Total Active Time</label>
                                </div>
                                <div class="col-12 col-lg-10 text-center my-3">
                                    ...
                                    ?>
                                    <label class="form-label fs-4 text-light">
                                        <?php
                        ...
                        <div class="offset-1 offset-lg-4 col-10 col-lg-4 my-3 rounded border1">
                            <div class="row g-1">
                                <div class="col-12 text-center">
                                    <label class="form-label fs-4 fw-bold text-decoration-underline">Best Sold Item</label>
                                </div>
                                <?php
                                ...
                                ?>
                                    <div class="col-12 text-center shadow">
                                        <img src="<?php echo $image_data["code"]; ?>" class="img-fluid rounded-top" style="height: 10vh;" />
                                        <div><i class="bi bi-award-fill fs-1 text-warning"></i></div>
                                    </div>
                                    <div class="col-12 text-center my-3">
                                        ...
                                        <span class="fs-4 font">Rs. <?php echo $qty_data["qty_total"] * $product_data["price"]; ?> .00</span>
                                    </div>
                                <?php
                        ...
                        <!-- <div class="offset-1 offset-lg-4 col-10 col-lg-4 my-3 rounded-5 bg-primary">
                            <div class="row g-1">
                                <?php
                                if ($freq_num > 0) {
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center shadow">
                                        <img src="resource/user1.svg" class="img-fluid rounded-top" style="height: 250px;" />
                                    </div>
                                    <div class="col-12 text-center my-3">
                                        <span class="fs-5 fw-bold">----- -----</span><br />
